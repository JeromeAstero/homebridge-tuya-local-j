class BaseAccessory {
    ...
    convertBrightnessFromHomeKitToTuya(value) {
        const min = this.device.context.minBrightness != null ? this.device.context.minBrightness : 10;
        const scale = this.device.context.scaleBrightness || 0;
