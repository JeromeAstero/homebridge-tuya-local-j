...
class RGBWLightAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        const characteristicColorTemperature = service.getCharacteristic(Characteristic.ColorTemperature)
            ...
            .updateValue(dps[this.dpMode] === this.cmdWhite ? 400 : 140)
    ...
    getBrightness(callback) {
        this.log.info('getBrightness: device.state', this.device.state[this.dpMode]);
    ...
    setColorTemperature(value, callback) {
        ...
        this.log.info(`newColor(h): ${newColor.h}`);
        this.log.info(`newColor(s): ${newColor.s}`);
        this.log.info(`newColor(b): ${newColor.b}`);
        ...
        this.setBrightness(this.convertBrightnessFromTuyaToHomeKit(this._getCustomDP(this.device.context.dpBrightness)));
