...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        ...
        this.log.info(`currentBrightness: ${currentBrightness}`);
        this.setBrightness(this.convertBrightnessFromTuyaToHomeKit(currentBrightness + 1));
        this.setBrightness(this.convertBrightnessFromTuyaToHomeKit(currentBrightness));
