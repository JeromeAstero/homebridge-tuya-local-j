...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        ...
        const brightnessValue = this.device.state[this.dpBrightness];
        this.log.info(`[setColorTemperature]: brightnessValue ${brightnessValue}`);
        this.log.info(`[setColorTemperature]: brightnessValue+1 ${brightnessValue+1}`);
        this.setMultiState(
            {
                [this.dpMode]: this.cmdWhite,
                [this.dpBrightness]: brightnessValue+1
            },
            callback);
