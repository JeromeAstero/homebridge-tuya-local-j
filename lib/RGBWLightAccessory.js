...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        ...
        this.log.info(`currentDPMode: ${this.device.context[this.dpMode]}`);
        this.log.info(`currentBright: ${this.device.context[this.dpBrightness]}`);
        this.setMultiState({[this.dpMode]: this.cmdWhite, [this.dpBrightness]: this.device.context[this.dpBrightness]}, callback);
        this.log.info(`newDPMode: ${this.device.context[this.dpMode]}`);
        this.log.info(`newBright: ${this.device.context[this.dpBrightness]}`);
