...
class RGBWLightAccessory extends BaseAccessory {
            ...
            switch (state[this.dpMode]) {
                ...
                default:
                    if (changes.hasOwnProperty(this.dpColor)) {
                        ...
                        /*if (characteristicColorTemperature.value !== 0) characteristicColorTemperature.updateValue(140);*/
    ...
    setColorTemperature(value, callback) {
        ...
        this.setMultiState({[this.dpMode]: this.cmdWhite, [this.dpBrightness]: this.convertBrightnessFromHomeKitToTuya(value)}, callback);
    }
