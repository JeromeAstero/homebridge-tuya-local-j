...
class RGBWLightAccessory extends BaseAccessory {
    ...
    getBrightness(callback) {
        this.log.info('getBrightness: device.state', this.device.state[this.dpMode], 'return', this.convertBrightnessFromTuyaToHomeKit(this.device.state[this.dpBrightness]));
