...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        ...
        this.log.info(`dpBrightness: ${this.device.state[this.dpBrightness]}`);
        this.setBrightness(this.convertBrightnessFromTuyaToHomeKit(this.device.state[this.dpBrightness]));
