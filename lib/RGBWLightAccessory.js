...
class RGBWLightAccessory extends BaseAccessory {
    ...
    getBrightness(callback) {
        if (this.device.state[this.dpMode] === this.cmdWhite) {
            this.log.info(`[method]getBrightness(), device state=${this.device.state[this.dpMode]}, return=${this.convertBrightnessFromTuyaToHomeKit(this.device.state[this.dpBrightness])}`);
            ...
            this.log.info(`[method]getBrightness(), device state=${this.device.state[this.dpMode]}, return=${this.convertColorFromTuyaToHomeKit(this.device.state[this.dpColor]).b}`);
            callback(null, this.convertColorFromTuyaToHomeKit(this.device.state[this.dpColor]).b);
        }
    }

    setBrightness(value, callback) {
        this.log.info(`[method]setBrightness(), value=${value}`);
    ...
    setColorTemperature(value, callback) {
        this.log.info(`[method]setColorTemperature(), value=${value}`);
        ...
        this.log.info(`[method]setColorTemperature(), dpBrightness=${currentBrightness}`);
        this.log.info(`[method]setColorTemperature(), characteristicBrightness=${newColor.b}`);
