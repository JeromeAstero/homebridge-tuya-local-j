...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        this.log.info('[start]: setColorTemperature');
        this.log.info(`[setColorTemperature]: this.device.state[this.dpBrightness] ${this.device.state[this.dpBrightness]}`);
        this.log.info(`[setColorTemperature]: this.device.state[this.dpBrightness]+1 ${this.device.state[this.dpBrightness]+1}`);
        this.setMultiState(
            {
                [this.dpMode]: this.cmdWhite,
                [this.dpBrightness]: this.device.state[this.dpBrightness]
            },
            callback);
