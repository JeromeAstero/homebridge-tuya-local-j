...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        ...
        this.log.debug(`device{name=${this.device.context.name}, id=${this.device.context.id}, ip=${this.device.context.ip}}; [method]setColorTemperature(), dpBrightness=${currentBrightness}`);
        this.log.debug(`device{name=${this.device.context.name}, id=${this.device.context.id}, ip=${this.device.context.ip}}; [method]setColorTemperature(), characteristicBrightness=${newColor.b}`);
