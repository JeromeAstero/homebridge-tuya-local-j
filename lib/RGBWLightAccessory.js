...
class RGBWLightAccessory extends BaseAccessory {
    ...
    setColorTemperature(value, callback) {
        this.log.info(`setWhiteMode: ${value}`);
        this.log.info(`dpMode: ${this.dpMode}`);
        this.log.info(`cmdWhite: ${this.cmdWhite}`);
        // this.setMultiState({[this.dpMode]: this.cmdWhite, [this.dpBrightness]: this.convertBrightnessFromHomeKitToTuya(this.device.state[this.dpBrightness])}, callback);
